  ...
  return (
    <>
        ...
        <div className="w-full bg h-auto bg-white flex-col overflow-y-auto">
          <div className="h-14 flex justify-between items-center border-b-[1px] px-7">
            <div className="flex h-full items-center gap-4 font-medium">
              <div className="md:hidden bg-sky-100 rounded-3xl p-1">
                <BiMenuAltLeft size={30}/>
              </div>
              <div className="md:border-r-2 pr-5 text-[#1C4980] text-[20px]">
                Assessment
              </div>
              <div className="text-[14px] hidden md:block text-[#0073E6] h-auto">
                My Assessments
              </div>
            </div>
            <div>
      ...
      {isOpenModal ? (
        <div
          onClick={closeModal}
          className="backdrop fixed w-screen h-full top-0 left-0 bg-gray-500  bg-opacity-25 flex justify-center items-center"
        >
          <InputModal
